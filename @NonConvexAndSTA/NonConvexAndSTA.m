           ...
           for i = 1 : input.kar.number_of_subregions
               ...
               for j = 1 : obj.M
                   ...
                   if j == 1
                       ...
                       obj.kinematic_buffer_y_m = obj.kinematic_buffer_x_m + obj.input.kar.subregion_parameters(i, 3) / 2 - obj.sf_sign * obj.input.kar.subregion_parameters(i, 4);
                       obj.kinematic_buffer_y_M = obj.kinematic_buffer_x_M - obj.input.kar.subregion_parameters(i, 3) / 2 - obj.sf_sign * obj.input.kar.subregion_parameters(i, 4);
                       
                       obj.kinematic_and_temporal_buffer_y_m = obj.kinematic_and_temporal_buffer_x_m + ( + obj.input.kar.subregion_parameters(i, 3) / 2 - obj.sf_sign * obj.input.kar.subregion_parameters(i, 4)) * ...
                                                               (1 - obj.lambda_j(j, 1) ^ obj.ni_j(j, 1)) / (obj.ni_j(j, 1) * log(obj.lambda_j(j, 1)));
                       obj.kinematic_and_temporal_buffer_y_M = obj.kinematic_and_temporal_buffer_x_M + ( - obj.input.kar.subregion_parameters(i, 3) / 2 - obj.sf_sign * obj.input.kar.subregion_parameters(i, 4)) * ...
                                                               (1 - obj.lambda_j(j, 1) ^ obj.ni_j(j, 1)) / (obj.ni_j(j, 1) * log(obj.lambda_j(j, 1)));
                       ...
                       obj.kinematic_buffer_y_m = obj.kinematic_buffer_x_m + obj.input.scheme_parameters.d_ay_subsequent / 2 - obj.sf_sign * obj.input.scheme_parameters.ell_y_subsequent;
                       obj.kinematic_buffer_y_M = obj.kinematic_buffer_x_M - obj.input.scheme_parameters.d_ay_subsequent / 2 - obj.sf_sign * obj.input.scheme_parameters.ell_y_subsequent;
                       
                       obj.kinematic_and_temporal_buffer_y_m = obj.kinematic_and_temporal_buffer_x_m + ( + obj.input.scheme_parameters.d_ay_subsequent / 2 - obj.sf_sign * obj.input.scheme_parameters.ell_y_subsequent) * ...
                                                               (1 - obj.lambda_j(j, 1) ^ obj.ni_j(j, 1)) / (obj.ni_j(j, 1) * log(obj.lambda_j(j, 1)));
                       obj.kinematic_and_temporal_buffer_y_M = obj.kinematic_and_temporal_buffer_x_M + ( - obj.input.scheme_parameters.d_ay_subsequent / 2 - obj.sf_sign * obj.input.scheme_parameters.ell_y_subsequent) * ...
                                                               (1 - obj.lambda_j(j, 1) ^ obj.ni_j(j, 1)) / (obj.ni_j(j, 1) * log(obj.lambda_j(j, 1)));
