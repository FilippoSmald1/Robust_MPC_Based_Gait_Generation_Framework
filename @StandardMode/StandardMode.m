classdef StandardMode < FeasibilityDrivenBase & handle
    ...
    methods (Access = public)
        ...
        function [u, ftstp] = solve(obj, state, input)
            ...
            % x component           
            obj.b_ineq(1:obj.input.scheme_parameters.C, 1) = - state.x(3,1) + obj.input.footstep_plan.zmp_centerline_x + obj.input.scheme_parameters.d_z / 2;
            obj.b_ineq(obj.input.scheme_parameters.C : 2 * obj.input.scheme_parameters.C - 1, 1) = + state.x(3,1) - obj.input.footstep_plan.zmp_centerline_x + obj.input.scheme_parameters.d_z / 2;
            ...
            % y component
            obj.b_ineq(1:obj.input.scheme_parameters.C, 1) = - state.y(3,1) + obj.input.footstep_plan.zmp_centerline_y + obj.input.scheme_parameters.d_z / 2;
            obj.b_ineq(obj.input.scheme_parameters.C : 2 * obj.input.scheme_parameters.C - 1, 1) = + state.y(3,1) - obj.input.footstep_plan.zmp_centerline_y + obj.input.scheme_parameters.d_z / 2;
